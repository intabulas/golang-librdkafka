...
RUN curl -fsSLO --compressed "https://github.com/goreleaser/nfpm/releases/download/v2.14.0/nfpm_2.14.0_Linux_x86_64.tar.gz" \
  && tar -xzvf "nfpm_2.14.0_Linux_x86_64.tar.gz" -C /usr/local/bin  --no-same-owner
